    ...
    const handleSubmit = (e) =>{
        ...
        if(novoEvento.title && novoEvento.start && novoEvento.end){
            ...
            if(startDate >= endDate){
                alert('A data de inicio deve ser anterior a data de término')
                return;
            }
                        ...
                        <Row>
                            ...
                            <Col xs ={9}>
                                <Form.Group controlId='formBasicTipo'>
                                    ...
                                    <Form.Control type='text' name='tipo' placeholder='Digite a Tipo' value={novoEvento.tipo} onChange={handleChange}/>
                                </Form.Group>
                            </Col>
                        </Row>
                    </div>
